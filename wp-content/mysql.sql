...
INSERT INTO `wp_usermeta` VALUES (1,1,'nickname','wpengine'),(2,1,'first_name',''),(3,1,'last_name',''),(4,1,'description','This is the \"wpengine\" admin user that our staff uses to gain access to your admin area to provide support and troubleshooting. It can only be accessed by a button in our secure log that auto generates a password and dumps that password after the staff member has logged in. We have taken extreme measures to ensure that our own user is not going to be misused to harm any of our clients sites.'),(5,1,'rich_editing','true'),(6,1,'comment_shortcuts','false'),(7,1,'admin_color','fresh'),(8,1,'use_ssl','0'),(9,1,'show_admin_bar_front','true'),(10,1,'locale',''),(11,1,'wp_capabilities','a:1:{s:13:\"administrator\";b:1;}'),(12,1,'wp_user_level','10'),(13,1,'dismissed_wp_pointers',''),(14,1,'show_welcome_panel','1'),(15,2,'nickname','stevedixongit'),(16,2,'first_name',''),(17,2,'last_name',''),(18,2,'description',''),(19,2,'rich_editing','true'),(20,2,'comment_shortcuts','false'),(21,2,'admin_color','fresh'),(22,2,'use_ssl','0'),(23,2,'show_admin_bar_front','true'),(24,2,'locale',''),(25,2,'wp_capabilities','a:1:{s:13:\"administrator\";b:1;}'),(26,2,'wp_user_level','10');
...
INSERT INTO `wp_users` VALUES (1,'wpengine','$P$Bq2OsB.X5V6OXqMyfwx/mpTaqmTJP0.','wpengine','bitbucket@wpengine.com','http://wpengine.com','2017-01-05 16:04:41','',0,'wpengine'),(2,'stevedixongit','$P$BV/W90v.UWBrMTWt7h1JeCGignAQyz.','stevedixongit','technical@door4.com','http://stevedixongit.wpengine.com','2017-05-18 10:07:16','',0,'stevedixongit');
/*!40000 ALTER TABLE `wp_users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'wp_stevedixongit'
--

--
-- Dumping routines for database 'wp_stevedixongit'
--
